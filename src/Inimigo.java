public class Inimigo extends Entidade {
    ...
    public Inimigo(String nome, int vida, int dano, String capa, String capa_v, String capa_d, CartaDano ataque1, CartaDano ataque2, CartaEfeito efeito) { // Setup do inimigo
        super(nome, vida, 0);
        this.dano = dano;
        this.capa = capa;     
        this.capa_v = capa_v; 
